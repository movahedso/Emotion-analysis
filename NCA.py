...
def nca(data,target,n_components,random_state,max_iter):
    x_train, x_test, y_train, y_test = train_test_split(data, target,
                                                        random_state=random_state,
                                                        shuffle=True, train_size=0.8)
    x_train, x_test = scale(x_train, x_test, y_train)
    rdt = NeighborhoodComponentsAnalysis(n_components=n_components,
                                 random_state=random_state,
                                 max_iter=max_iter,verbose=4)
...
print("-----------------------------------------------------------------")
print("Neighborhood components analysis")
x_train,x_test,y_train,y_test=nca(data,target,n_components,random_state,max_iter)
print("\nMLP:")
