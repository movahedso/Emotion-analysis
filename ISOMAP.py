...
def isomap(data,target,n_components,random_state,max_iter):
    x_train, x_test, y_train, y_test = train_test_split(data, target,
                                                        random_state=random_state,
                                                        shuffle=True, train_size=0.8)
    x_train, x_test = scale(x_train, x_test, y_train)
    rdt = Isomap(n_components=n_components,max_iter=max_iter,n_jobs=-1,n_neighbors=5)
...
print("-----------------------------------------------------------------")
print("Isometric Mapping")
x_train,x_test,y_train,y_test=isomap(data,target,n_components,random_state,max_iter)
print("\nMLP:")
